...
#define BSP_LCD_PIXEL_FORMAT        LCD_COLOR_PIXEL_FORMAT_RGB565
#define BSP_LCD_BITS_PER_PIXEL      (16)
#else
#define BSP_LCD_COLOR_FORMAT        (ESP_LCD_COLOR_FORMAT_RGB888)
#define BSP_LCD_PIXEL_FORMAT        LCD_COLOR_PIXEL_FORMAT_RGB888
...
#define BSP_LCD_MIPI_DSI_LANE_BITRATE_MBPS (800)
#define BSP_LCD_MIPI_DSI_LANE_NUM          (1)    // WLK2802MIPI-15P/ST7701S uses 1 data lane
