...
const p4ProtocolSource = readFileSync(join(srcDir, "../../firmware/main/pet_p4_protocol.c"), "utf8");
const p4NativeUsbSource = readFileSync(join(srcDir, "../../firmware/main/pet_p4_usb_native.c"), "utf8");
