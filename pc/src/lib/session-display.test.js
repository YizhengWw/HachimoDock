/**
 * [Input] Ordered Agent lifecycle events and periodic snapshots.
 * [Output] Regression coverage for adjacent-snapshot active admission,
 *          transient visual-identity dedupe, and 60-second done/error retention.
