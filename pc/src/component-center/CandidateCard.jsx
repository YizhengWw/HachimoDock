/**
 * [Input] component, explicit kind, local/installed/enabled state, and select/sync/delete actions.
 ...
 *          one repeatable sync/update action plus one consolidated delete entry.
      ...
      <footer className="candidate-card__actions">
        {onDeviceAction && (
          ...
          >
            ...
            {isInstalled ? "已同步到设备，点击同步更新" : "同步到设备"}
          </Button>
        )}
        {onDelete && (
          <Button
