 ...
 * [Pos] .clawpkg contract node in pc/src-tauri/src
 * [Sync] If this file changes, update `pc/.folder.md` and the mirrored frontend contract.
 */
...
/// (slot_id, max_utf8_bytes). MUST mirror pc/src/lib/clawpkg-contract.js.
