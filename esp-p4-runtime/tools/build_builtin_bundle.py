#!/usr/bin/env python3
"""
[Input] Canonical built-in component manifests plus runtime/button JSON under ref/.
[Output] Deterministic firmware-embedded component bundle, or a stale-bundle check.
...
COMPONENT_ROOT = REPOSITORY_ROOT / "ref" / "builtin-clawpkgs"
