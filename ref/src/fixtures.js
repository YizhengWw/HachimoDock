  ...
  components: [
    {
      ...
      goal: "SW3 开始或重开，摇杆左右移动挡板；退出跟随设备全局设置；接球得分，漏球后结算。",
    ...
    },
    {
      ...
      accent: "blue",
      gameType: "flappy",
      goal: "SW3 单键拍翅；退出跟随设备全局设置；飞鸟受持续重力影响，管道自动横移，碰撞后结算，成功穿管得分，再次拍翅即可重开。",
    ...
    },
    {
      ...
      accent: "purple",
      gameType: "blocks",
      goal: "SW3 开始或重开；摇杆左/右移动、上旋转、下快速落下，退出跟随设备全局设置，填满一行后自动消除并计分。",
    ...
    },
    {
      ...
      accent: "green",
      gameType: "snake",
      goal: "蛇会持续前进；SW3 开始或重开，摇杆左右转向，退出跟随设备全局设置，吃到食物增长并计分，撞墙或撞到自己后结算。",
    ...
    },
    {
      ...
      status: "available",
      accent: "pink",
      goal: "25 分钟专注与 5 分钟休息自动循环；SW3 暂停或继续，SW2 跳过，摇杆下重置，退出跟随设备全局设置。",
      ...
      dashboard: {
        ...
        badge: "0",
        note: "右上显示完成轮次",
        footer: "SW3暂停 · SW2跳过 · 摇杆下重置 · 全局键退出",
    ...
    },
    {
      ...
      status: "available",
      accent: "green",
      goal: "每 60 分钟提醒补水；SW3 确认喝水，SW2 暂停或恢复，摇杆右切换视图，退出跟随设备全局设置。",
      ...
      dashboard: {
        ...
        badge: "0",
        note: "每 60 分钟提醒一次",
        footer: "SW3我喝了 · SW2暂停 · 摇杆右切换 · 全局键退出",
    ...
    },
    {
      ...
      status: "available",
      accent: "blue",
      goal: "实时展示当前 coding agent 的 Token 统计；SW3 看总量，SW2 看输入，摇杆右看输出，退出跟随设备全局设置。",
      ...
      dashboard: {
        ...
        metricUnit: "TOKEN",
        note: "缓存 —",
        footer: "SW3总量 · SW2输入 · 摇杆右输出 · 全局键退出",
        visualStyle: "pixel",
        visualPalette: "arcade",
        visualLayout: "tool",
        visualSprite: "gauge",
