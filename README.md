<div align="center">
  ...
  <p>
    <img alt="License" src="https://img.shields.io/badge/license-proprietary-2a2620" />
...
这个 GitHub 仓库提供 Windows/macOS 桌面客户端和 ESP32-P4 完整出厂固件；硬件端资料在 OSHWHub 维护。
...
- Apple silicon Mac 下载 `HachimoDock-Pet-Manager_0.1.47_macOS-arm64.dmg`；
- Windows x64 下载 `HachimoDock-Pet-Manager_0.1.47_Windows-x64-setup.exe`；
...
当前正式二进制版本使用专有的 [HachimoDock Binary Distribution License](LICENSE)。第三方材料继续遵循 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) 中各自的许可证；历史公开版本继续保留其发布时已经授予的权利。
...
- [Clawd on Desk](https://github.com/rullerzhou-afk/clawd-on-desk)（本项目使用其 MIT 时期源码）— 桌面端 Agent 状态监控与 Hook Bridge 的部分来源；完整 Notice 与提交边界见 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md)。
...
Official binary releases are distributed under the proprietary [HachimoDock Binary Distribution License](LICENSE). Existing GPL/AGPL copies retain the rights already granted with those copies. Third-party notices remain available in [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).
