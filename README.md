...
HachimoDock 是 Agent 的专属小屏。它将 PC 上运行的各类 Agent（Codex、Claude Code、OpenClaw 等）具象为工位上一只可见、可触碰的桌面宠物。
...
<p align="center">
  <img src="assets/image_07.gif" alt="空闲与触摸反馈" />
</p>
...
HachimoDock 软件由 PC 管理端和设备端运行时组成：
...
<p align="center">
  <img src="assets/community-qr.png" alt="HachimoDock 社群二维码" width="220" />
</p>
